...
In [LOTUS](https://github.com/lotus-data/lotus), a pandas-like API, this is represented as the [program below](https://github.com/TAG-Research/TAG-Bench/blob/76d5795d6e35f770894d3f180af58b6638964fcf/tag/hand_written.py#L51):
...
As shown below, **using a single consumer-grade GPU, BlendSQL can match the performance of a 70b model hosted on 8 A100s, in 1/3 of the time.**

|          | Model                           | Hardware          | Accuracy (↑) | Execution Time (s) (↓) | Avg. Tokens per Program |
|----------|---------------------------------|-------------------|--------------|------------------------|------------------------|
| LOTUS[^4]    | Llama-3.1-70b-instruct          | 8 A100, 80GB      | 0.55         | 3.0475                 |127                  |
| BlendSQL | Meta-Llama-3.1-8B-Instruct.Q6_K | 1 RTX 5080, 16GB  | 0.55         | 0.935                  |76                   |

[^4]: These numbers are taken from Table 1 of [their paper](https://arxiv.org/pdf/2408.14717)
